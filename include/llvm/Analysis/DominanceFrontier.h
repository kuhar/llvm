...
public:
 ...
 ///
 inline const std::vector<BlockT *> &getRoots() const { return Roots; }
...
public:
 typedef DominatorTreeBase<BlockT, false> DomTreeT;
...
public:
 typedef DominatorTreeBase<BasicBlock, false> DomTreeT;
