...
template <class BlockT, bool IsInverse>
void DominanceFrontierBase<BlockT, IsInverse>::removeBlock(BlockT *BB) {
...
template <class BlockT, bool IsInverse>
void DominanceFrontierBase<BlockT, IsInverse>::addToFrontier(iterator I,
                                                             BlockT *Node) {
...
template <class BlockT, bool IsInverse>
void DominanceFrontierBase<BlockT, IsInverse>::removeFromFrontier(
...
template <class BlockT, bool IsInverse>
bool DominanceFrontierBase<BlockT, IsInverse>::compareDomSet(
...
template <class BlockT, bool IsInverse>
bool DominanceFrontierBase<BlockT, IsInverse>::compare(
    DominanceFrontierBase<BlockT, IsInverse> &Other) const {
...
template <class BlockT, bool IsInverse>
void DominanceFrontierBase<BlockT, IsInverse>::print(raw_ostream &OS) const {
...
template <class BlockT, bool IsInverse>
void DominanceFrontierBase<BlockT, IsInverse>::dump() const {
  print(dbgs());
}
#endif
