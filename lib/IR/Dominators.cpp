...
template struct llvm::DomTreeBuilder::Update<DomTreeBuilder::BBDomTree>;
template struct llvm::DomTreeBuilder::Update<DomTreeBuilder::BBPostDomTree>;
...
template void llvm::DomTreeBuilder::ApplyUpdates<DomTreeBuilder::BBDomTree>(
    DomTreeBuilder::BBDomTree &DT, DomTreeBuilder::BBDomTreeUpdates);
template void llvm::DomTreeBuilder::ApplyUpdates<DomTreeBuilder::BBPostDomTree>(
    DomTreeBuilder::BBPostDomTree &DT, DomTreeBuilder::BBPostDomTreeUpdates);
